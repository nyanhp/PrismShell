...
@{
	...
	'StartPrismPrint.WaitingForGodot'        = 'Warte auf Fertigstellung des Drucks von {1} auf {0}'
	'StartPrismPrint.PrintFinished'          = '{1} erfolgreich auf {0} gedruckt!'
	'StartPrismPrint.Starting'               = 'Drucke {1} auf {0} mit Profil ID {2}/Name {3}'
