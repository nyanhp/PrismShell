...
@{
	...
	'StartPrismPrint.Starting'               = 'Printing {1} on {0} with profile ID {2}/Name {3}'
	...
	'ShowPrismThumbnail.WindowsOnly'         = 'Viewing the preview is currently Windows PowerShell only.'
}